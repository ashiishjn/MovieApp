...
class RecyclerViewAdapterHomeScreen(recyclerDataArrayList: ArrayList<HomeScreenPosterModel>, mcontext: Context) :
    RecyclerView.Adapter<RecyclerViewAdapterHomeScreen.RecyclerViewHolder>() {

    private val posterList: ArrayList<HomeScreenPosterModel>
    ...
    override fun onBindViewHolder(holder: RecyclerViewHolder, position: Int) {
        ...
        val recyclerData: HomeScreenPosterModel = posterList[position]
